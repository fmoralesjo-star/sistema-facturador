...
title Migración: Agregar Campo SKU a Productos
color 0B
cls
echo.
echo ========================================
echo   MIGRACIÓN: AGREGAR CAMPO SKU
echo   Sistema Facturador v2.0
echo ========================================
echo.
echo Este script agregará el campo SKU a la tabla productos
echo.
...
if defined DB_PASSWORD (
    ...
    psql -h %DB_HOST% -p %DB_PORT% -U %DB_USERNAME% -d %DB_DATABASE% -f "migrations\001_agregar_sku_productos.sql"
) else (
    echo.
...
if errorlevel 1 (
    ...
    echo ========================================
    echo.
    echo El campo SKU ha sido agregado a la tabla productos
    echo.
)
