...
\restrict vXgGpUGq9cg7WoCyCiF3UWalRlGRiaR5Ot4fF7Fi0Dv9Qmpy376zsdXHQLvdAfB
...
CREATE TABLE public.puntos_venta (
    ...
    secuencia_factura integer DEFAULT 1 NOT NULL,
    secuencia_nota_credito integer DEFAULT 1 NOT NULL
);
...
1	backup_2026-01-01T23-30-28-392Z.sql	114815	SUCCESS	\N	2026-01-01 18:30:28.641725
2	backup_2026-01-02T02-22-53-024Z.sql	114897	SUCCESS	\N	2026-01-01 21:22:53.859332
\.
...
COPY public.configuraciones (clave, valor, descripcion, tipo, grupo) FROM stdin;
sri_regimen_rimpe	false	Contribuyente Régimen RIMPE	boolean	EMISION
sri_agente_retencion		Resolución Agente de Retención	string	EMISION
sri_contribuyente_especial		Resolución Contribuyente Especial	string	EMISION
sri_ambiente	pruebas	Ambiente (pruebas/produccion)	string	EMISION
sri_tipo_emision	1	Tipo Emisión (1: Normal)	string	EMISION
impuesto_iva_codigo	2	Código Impuesto IVA	string	EMISION
impuesto_iva_porcentaje	15	Porcentaje IVA Actual	number	EMISION
sri_timeout	20	Timeout SRI (segundos)	number	EMISION
ride_logo_path		Ruta del Logotipo	string	RIDE
ride_info_adicional	Gracias por su compra	Texto adicional fijo	string	RIDE
ride_color_primario	#3366cc	Color Primario PDF	string	RIDE
cliente_email_obligatorio	false	Email Cliente Obligatorio	boolean	RIDE
cliente_direccion_obligatoria	false	Dirección Cliente Obligatoria	boolean	RIDE
secuencial_reset_password	admin123	Contraseña para resetear secuenciales	string	PUNTOS
nombre_empresa	Mi Empresa	Nombre de la empresa	string	GENERAL
ruc_empresa		RUC de la empresa	string	GENERAL
direccion_empresa		Dirección de la empresa	string	GENERAL
telefono_empresa		Teléfono de la empresa	string	GENERAL
email_empresa		Email de la empresa	string	GENERAL
smtp_host		Servidor SMTP (Ej: smtp.gmail.com)	string	CORREO
smtp_port	587	Puerto SMTP (587 o 465)	number	CORREO
smtp_user		Usuario/Email SMTP	string	CORREO
smtp_password		Contraseña SMTP o App Password	string	CORREO
smtp_secure	false	Usar SSL/TLS (true/false)	boolean	CORREO
smtp_from_name	Sistema Facturador	Nombre remitente	string	CORREO
\.
...
COPY public.email_logs (id, destinatario, asunto, error_detalle, estado, fecha_creacion, fecha_envio) FROM stdin;
\.
...
COPY public.puntos_venta (id, nombre, codigo, direccion, telefono, email, activo, observaciones, created_at, updated_at, tipo, es_principal, secuencia_factura, secuencia_nota_credito) FROM stdin;
1	MALL EL JARDIN	001	AV REPUBLICA Y AV AMAZONAS	0982885713	fmoralesjo@gmail.com	t	\N	2025-12-26 16:28:55.537034	2025-12-26 16:28:55.537034	TIENDA	f	1	1
2	QUICENTRO SHOPPING	002	AV AMAZONAS Y 6 DE DICIEMBRE	0982885713	fmoralesjo@gmail.com	t	\N	2025-12-26 16:34:08.454933	2025-12-26 16:34:08.454933	TIENDA	f	1	1
3	SCALA SHOPPING	003	CUMBAYA	0982885713	fmoralesjo@gmail.com	t	\N	2025-12-26 16:36:24.832909	2025-12-26 16:36:24.832909	TIENDA	f	1	1
\.
...
\unrestrict vXgGpUGq9cg7WoCyCiF3UWalRlGRiaR5Ot4fF7Fi0Dv9Qmpy376zsdXHQLvdAfB
