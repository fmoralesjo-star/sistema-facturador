...
async function runSeed() {
    try {
        ...
        const configs = [
            ...
            { clave: 'smtp_password', valor: '', descripcion: 'Contraseña SMTP o App Password', tipo: 'string', grupo: 'CORREO' },
        ...
        for (const conf of configs) {
            ...
            if (existing.length === 0) {
                ...
                await queryRunner.query(`INSERT INTO configuraciones (clave, valor, descripcion, tipo, grupo) VALUES ($1, $2, $3, $4, $5)`, [conf.clave, conf.valor, conf.descripcion, conf.tipo, conf.grupo]);
            }
            else {
...
runSeed();
//# sourceMappingURL=seed-smtp.js.map